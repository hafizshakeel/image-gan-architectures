...
def main():
    ...
    # Loss functions: BCE for classification, L1 for image similarity
    # Not using WGAN-GP loss because it didn't perform well with PatchGAN.
    BCE = nn.BCEWithLogitsLoss()
    L1_LOSS = nn.L1Loss()

    # Load pre-trained model weights if needed
    ...
    for epoch in range(config.NUM_EPOCHS):
        ...
        # Save example images from validation set
